...
HOME_BODY = dedent("""\
    <section class="hero">
      <div class="container hero__inner">
        ...
        <p class="lede" data-reveal>Your partner in <em>brand identity</em> since 2003. Creative full-service promotional products, custom apparel, print and marketing &mdash; family-owned on the Outer Banks, shipping nationwide.</p>
